 ...
 * Description: Client-side controller for user authentication.
 * ============================================================================
 */
...
async function initialize() {
    ...
    try {
        ...
        /*
         * A failure here should not prevent the
         * authentication page from loading.
         */
...
function setFormState(
    ...
    DOM.authenticateBtn.disabled =
        disabled;

    DOM.username.disabled =
        disabled;

    DOM.password.disabled =
        disabled;

    DOM.exitBtn.disabled =
        disabled;
}
